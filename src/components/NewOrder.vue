...
<input type="number" placeholder="Get Amt Payable Here" @click="AmtPayable" v-model.lazy="neworder.amtPay">
<br>
<label> <b> Receipent Mobile No : </b> </label> 
<input type="number" placeholder="Enter Receipent Mob No" v-model.lazy="neworder.recMob">
<br>
